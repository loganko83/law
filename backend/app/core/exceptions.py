...
class ErrorCode(str, Enum):
    ...
    # Document errors (6.5xxx - between blockchain and external)
    DOCUMENT_NOT_FOUND = "DOCUMENT_6501"
    DOCUMENT_UPLOAD_FAILED = "DOCUMENT_6502"
    DOCUMENT_TOO_LARGE = "DOCUMENT_6503"
    DOCUMENT_TYPE_NOT_ALLOWED = "DOCUMENT_6504"
    OCR_FAILED = "DOCUMENT_6505"
